<?php
  ...
  $plot = mysqli_query($connect, "SELECT COUNT(*)AS plots FROM `plots`");
  $fetchPlot = mysqli_fetch_assoc($plot);


  $flat = mysqli_query($connect, "SELECT COUNT(*)AS flats FROM `flats`");
  $fetchFlat = mysqli_fetch_assoc($flat);


  $house = mysqli_query($connect, "SELECT COUNT(*)AS houses FROM `houses`");
  $fetchHouse = mysqli_fetch_assoc($house);


  $room = mysqli_query($connect, "SELECT COUNT(*)AS rooms FROM `rooms`");
