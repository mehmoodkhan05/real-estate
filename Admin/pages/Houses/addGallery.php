<?php
    ...
    if (isset($_POST["add_gallery"])) {
        ...
        $addGalleryQuery = mysqli_query($connect, "INSERT INTO house_gallery(g_img, o_id, h_id)VALUES('$newName', '$o_id', '$h_id')");
        if ($addGalleryQuery) {
            echo '<script>window.location.href = addGallery.php?id='.$h_id.'</script>';
        }
    }
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            $getHouseGallery = mysqli_query($connect, "SELECT * FROM house_gallery WHERE o_id = '$o_id' AND h_id = '$h_id'");
                            ...
                            if ($count < 1) {
                                ...
                                while ($rowGallery = mysqli_fetch_assoc($getHouseGallery)) {
                                    ...
                                    <div class="col-4">
                                        ...
                                        <hr>
                                        <a href="deleteImage.php?id='.$rowGallery['gallery_id'].'&h_id='.$h_id.'" style="width: 100%" class="btn btn-danger" >Delete</a>
                                    </div>
                                    ';
                                }
                            }
