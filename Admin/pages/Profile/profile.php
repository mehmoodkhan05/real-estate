    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control btn-pill" type="text" value="<?php echo $fetch_getOwnerQuery['o_password'] ?>" name="o_password" placeholder="Enter Your Password Here..." required>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer text-end">
                ...
                <a href="../Dashboard/index.php" class="btn btn-light">Cancel</a>
            </div>
            </form>
        </div>
        </div>
