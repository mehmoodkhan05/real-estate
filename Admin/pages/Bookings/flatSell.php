            ...
            <div class="table-responsive table">
                ...
                <tobody>
                    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT buy_flat.*, users.name AS user_name, users.contact, flats.f_price, flats.o_id FROM `buy_flat`
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            <tr>
                                ...
                                <td>0'.$row['contact'].'</td>
                                <td>
                                    <a href="ChangeSellFlat.php?id='.$row['f_buy_id'].'" class="btn btn-primary">Change Status!</a>
                                </td>
                            </tr>
                            ';
                        }
