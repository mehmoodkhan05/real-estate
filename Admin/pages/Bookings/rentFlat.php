            ...
            <div class="table-responsive table">
                ...
                <tobody>
                    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT booking_flat.*, users.name AS user_name, users.contact, flats.f_price FROM `booking_flat`
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            <tr>
                                ...
                                <td>0'.$row['contact'].'</td>
                                <td>
                                    <a href="ChangeRentFlat.php?id='.$row['f_b_id'].'" class="btn btn-primary">Change Status!</a>
                                </td>
                            </tr>
                            ';
                        }
