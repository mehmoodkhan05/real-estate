    ...
    <>
      <section className="">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-6 contact-left_side">
              <h1 className="m-5">Finest demo</h1>
              <p className="m-5">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi
                nesciunt omnis excepturi ipsa repellendus aliquid molestiae
                culpa, doloremque harum quisquam illo soluta perferendis maxime
                quibusdam cupiditate optio alias necessitatibus illum!
              </p>
